...
describe('RNS3.put', () => {
  ...
  describe('parsing the XML response', () => {
    const XML_RESPONSE = '<?xml version="1.0" encoding="UTF-8"?>\n<PostResponse><Location>https://s3.us-east-1.amazonaws.com/my-s3-bucket/uploads%2Fimage.jpg</Location><Bucket>my-s3-bucket</Bucket><Key>uploads/image.jpg</Key><ETag>"afba579120c3ed942f55c8ca50fe39fc"</ETag></PostResponse>'
    const response = {
      status: 201,
      text: XML_RESPONSE,
      headers: {}
    ...
    it('generates a policy and performs a request', () => {
      ...
      expect(result).toHaveProperty('body.postResponse.location', 'https://s3.us-east-1.amazonaws.com/my-s3-bucket/uploads%2Fimage.jpg')
